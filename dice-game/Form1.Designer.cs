namespace dice_game
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "6 Dice";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.button1_Click);
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(371, 91);
			this.button2.Name = "button2";
			this.button2.Size = new System.Drawing.Size(131, 47);
			this.button2.TabIndex = 1;
			this.button2.Text = "12 Dice";
			...
			this.button3.Text = "18 Dice";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(111, 249);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(131, 47);
			this.button4.TabIndex = 3;
			this.button4.Text = "22 Dice";
			this.button4.UseVisualStyleBackColor = true;
			this.button4.Click += new System.EventHandler(this.button4_Click);
			// 
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(371, 249);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(131, 47);
			this.button5.TabIndex = 4;
			this.button5.Text = "32 Dice";
			this.button5.UseVisualStyleBackColor = true;
			this.button5.Click += new System.EventHandler(this.button5_Click);
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(608, 249);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(131, 47);
			this.button6.TabIndex = 5;
			this.button6.Text = "100 Dice";
